...
.left[Slides https://ecocomplex.github.io/LatinR2022]
...
* El paquete estaba pensado para analizar redes con multiples capas
...
* Solamente se desrrolló con más de un tipo de interacción
...
---
# Red de Caleta Potter - Antartida
...
* Usamos el método de Pawar et al. 2012 "Dimensionality of consumer search space drives trophic interaction strengths"
...
* Se basa en regresiones alometricas que relacionan la tasa de busqueda y consumo con la masa corporal del depredador
...
--
##  Mas soporte para las redes multiplex <img src="Figures/multiplex.jpg" width="10%" align="middle">
